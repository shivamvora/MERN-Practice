                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <a className="btn btn-info " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills">Edit Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card mb-3">
                                <div className="card-body">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9 text-secondary">
                                            <a href="https://personal-portfolio-rust.vercel.app/
                                                "className="text-secondary remove_underline" target="_blank">
                                                https://personal-portfolio-rust.vercel.app/
                                            </a>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9 text-secondary">
                                            <a href="https://github.com/shivamvora" className="text-secondary remove_underline" target="_blank">shivamvora</a>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9 text-secondary">
                                            ...
                                            <a href="https://twitter.com/shivamp29995687" className="text-secondary remove_underline" target="_blank">shivamp29995687</a>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9 text-secondary">
                                            <a href="https://www.instagram.com/shivam_vora/" className="text-secondary remove_underline" target="_blank">shivam_vora</a>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9 text-secondary">
                                            <a href="https://www.facebook.com/shivam.vora.184/" className="text-secondary remove_underline" target="_blank">Shivam Vora</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
